...
/// </summary>
public static class AuthApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapAuthApi<TUser>(this IEndpointRouteBuilder endpoints)
